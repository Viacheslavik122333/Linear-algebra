\section{Линейные операторы}
    \begin{definition}
        ...
        Подпространство $U \subset V$ называется инвариантом относительно $\phi$ ($\phi$ - инвариантное), если: 
        $$\forall u \in U: \ \phi(u) \in U, \text{ т.е. }\phi(U) \subseteq U$$   
    \end{definition}
    \begin{example}\tab
        \begin{enumerate}
            \item Пусть $V = U \oplus W$. Рассмотрим $\phi: \ V \to W$. Пусть $\phi(u + w) = u$ - проекция $V$ на $U$ вдоль $W$. Тогда $U$ и $W$ - $\phi$ инвариантное продрпостранства и $\forall u \in U: \ \phi(u) = u$, а также $\forall w \in W: \ \phi(w) = w$. Итак: $U \cong V/W$
            \item Пусть $V = \R[t], \ \phi = \frac{d(...)}{dt}$ и $p(t) \to p'(t)$. Здесь инвариантом является подпространства $\R[t]_n \supset \R[t]_{n-1}, \ n \in \N \cup \{0\}$               
        \end{enumerate}
    \end{example}
    \begin{theorem}
