...
\section{Линейные операторы}
    ...
    \begin{example}\tab
        \begin{enumerate}
            ...
            \item Пусть $V = \R[t], \ \phi(f) = \frac{df}{dt}\Rightarrow p(t) \to p'(t)$. Здесь инвариантным является подпространство $\R[t]_n \supset \R[t]_{n-1}, \ n \in \N \cup \{0\}$               
        \end{enumerate}
    \end{example}
    \begin{theorem}
    ...
    \end{proof}
    \begin{remark}
        Пусть $U \subset V$ - инвариантное подпространство для линейного оператора $\phi: \ V \to V$\\
    ...
    \end{theorem}
    \begin{remark}
        В общем случае, если $V = U_1 \oplus ... \oplus U_s, \ U_i$ - инвариантны относительно $\phi: \ V \to V$, то в базисе, согласованном с этим разложением:
        $$A_\phi = \begin{pmatrix}
            B_1 & \null & 0\\
            \null & \ddots & \null \\
            0 & \null & B_s
